...
#如果需要重新计算这次的数据，需要将之前的数据中的report_status更新到这次的数据中去
sql100 = 'update %s as tbn join %s as tbo on tbn.entity_id=tbo.entity_id and tbn.date=tbo.date set tbn.report_status=tbo.report_status'%('report_illegal_daily',"备份数据")
cur.execute(sql100)
